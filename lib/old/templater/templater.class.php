...
class TTemplaterException extends TException{ }
class TTemplaterDisplayException extends TException{ 
	public $orign;
	public $code;
...
require_once 'templater/resource.class.php';
class TTemplater extends TStore
{
	/**
	 * left delimiter
	 * @var string
	...
	function display( $resource, $additional_vars= array() )
	{
		...
		if($this->cache === false || false === $code = $CC->get( $resource ) ){
